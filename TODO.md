...
- [ ] Add dark mode to components (:white_check_mark: create, edit, explore, home, landing, library, login, navbar, 404, notifications, profile, card, description, question, recap, score, waiting, register, sidebar, tag-list, invite)
