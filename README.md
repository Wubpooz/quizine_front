...
- [x] mobile friendliness (login, register, landing, waiting, navbar, sidebar, invite, tag-list) 
- [ ] TODO : profile, description, library, home, explore, edit, create, notif, score, recap, question
- [x] 404 page
