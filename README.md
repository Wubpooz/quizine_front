...
- [x] mobile friendliness (login, register, landing, waiting, navbar, sidebar, invite, tag-list, profile) 
- [ ] TODO : description, library, home, explore, edit, create, notif, score, recap, question
- [x] 404 page
